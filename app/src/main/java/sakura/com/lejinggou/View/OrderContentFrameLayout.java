            ...
            public void onMySuccess(String result) {
                ...
                try {
                    ...
                    if (1 == orderListsBean.getStatus()) {
                        ...
                        if (1 == p) {
                            if (null != orderListsBean.getData() && !orderListsBean.getData().isEmpty()) {
                                adapter = new MyOrderAdapter(context, orderListsBean.getData());
                            ...
                            if (null != orderListsBean.getData() && !orderListsBean.getData().isEmpty()) {
                                adapter.setDatas(orderListsBean.getData());
                            } else {
