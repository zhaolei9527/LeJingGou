...
import sakura.com.lejinggou.Bean.AboutDzaddBean;
...
public class AddAdressActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initview() {
        ...
        if (!TextUtils.isEmpty(getIntent().getStringExtra("id"))) {
            ...
            Ssx = getIntent().getStringExtra("Ssx");
            tv_check_address.setText(Ssx);
        }
    }
    ...
    private void addressDoedit() {
        ...
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "about/dzsav", "about/dzsav", params, new VolleyInterface(context) {
            @Override
            public void onMySuccess(String result) {
                dialog.dismiss();
                Log.e("addressAdd", result);
