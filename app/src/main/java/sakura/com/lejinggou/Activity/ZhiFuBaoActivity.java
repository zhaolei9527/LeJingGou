...
public class ZhiFuBaoActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        etName.setText(zfbname);
        etIdcard.setText(zfbacc);
    ...
    private void getLogin() {
        ...
        params.put("zfbname", etName.getText().toString().trim());
        params.put("zfbacc", etIdcard.getText().toString().trim());
        Log.e("LoginActivity", "params:" + params);
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "about/zfb" + App.LanguageTYPEHTTP, "about/zfb", params, new VolleyInterface(context) {
            @Override
